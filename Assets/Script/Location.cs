...
public class Location : MonoBehaviour
{
    ...
    void Update()
    {
        if (gps_ok)
        {
            ...
            // }
            //12.930390010264807, 77.60678448988628
            //12.930373010380398, 77.60648596039671
            //12.93328388191063, 77.60656552934242

            double distanceBetween = distance((double)currLoc.lat, (double)currLoc.lon, (double)12.93328388191063, (double)77.60656552934242, 'K');
            ...
            if (distanceBetween < 0.01)
            {
                ...
                {
                    createdGeo = true;
                    Instantiate(npc, new Vector3(), Quaternion.identity);
                }
                debugTxt.text += "\nfound npc";
            }
        }
